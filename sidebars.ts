...
const sidebars: SidebarsConfig = {
    tutorialSidebar: [
        ...
        },
        {
            type: 'category',
            label: '三、网络安全',
            items: ['network/index', 'network/protocol-security', 'network/firewall', 'network/ids-ips', 'network/vpn-ipsec', 'network/tls-https', 'network/attacks', 'network/security-system-model', 'network/physical-security', 'network/physical-isolation', 'network/security-audit', 'network/attack-principles', 'network/active-defense', 'network/security-assessment'],
        },
        {
            type: 'category',
            label: '四、系统安全',
            items: ['system/index', 'system/os-security', 'system/access-control', 'system/authentication', 'system/malware', 'system/malware-advanced', 'system/vulnerability-incident', 'system/vulnerability-management'],
        },
        {
            type: 'category',
            label: '五、应用安全',
